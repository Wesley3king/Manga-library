      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text("Caso nunca tenha acessado a Biblioteca Oculta, por padrão a senha é: 0000. tebha em mente que você pode alterar a senha nas configurações, porém não há como recupera-la, mesmo que você faça um backup ainda mantida a mesma senha para abrila",
              style: TextStyle(
                color: Colors.grey,
                fontSize: 13
              ),
            ...
            const SizedBox(height: 5),
            const Text("1 - Não deve-se ter um mesmo livro na Biblioteca Oculta que tambem esteja na Biblioteca principal(e vice versa). Isto geraria uma duplicidade que aumentaria desnecessariamente o consumo de memória do dispositivo.")
          ],
        ),
      ),
    );
