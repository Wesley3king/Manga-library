...
import 'package:manga_library/app/extensions/izakaya/scraping/scraping_izakaya.dart';
...
class ExtensionIzakaya implements Extension {
  @override
  dynamic fetchServices = "";
  @override
  String nome = "Izakaya";
  @override
  String extensionPoster = "Izakaya.png";
  @override
  int id = 21;
  @override
  bool nsfw = true;
  ...
  String getLink(String pieceOfLink) =>
      'https://leitorizakaya.net/manga/$pieceOfLink/';
  ...
  Future<List<Books>> search(String txt) async {
    debugPrint("IZAKAYA SEARCH STARTING...");
    try {
      ...
      debugPrint("erro no search at ExtensionIzakaya: $e");
      return [];
    }
  }
}
