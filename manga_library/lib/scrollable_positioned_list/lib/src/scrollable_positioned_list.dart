...
class ScrollablePositionedList extends StatefulWidget {
  ...
  /// scrollController for scrollBar
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void _updatePositions() {
    ...
    if (itemPositions.isNotEmpty) {
      /// PT -BR : eu não sei o que isto faz, mas como estava dando erro retirei.
      /// EN : I don't know what this does, but as it was giving an error I removed it.
