...
void main() {
  ...
  test("deve retornar um MangaInfoOffLineModel", () async {
    var data =
        await extend.mangaDetail("mesmo-eu-tendo-decidido-jogar-com-voce"); // tiny-evil michitarita-seikatsu-nerawareta-megane-jimitsuma mesmo-eu-tendo-decidido-jogar-com-voce
    debugPrint("data: $data");
  });
